...
class CorrentWrongOverlay extends StatefulWidget {

  final bool _isCorrect;
  final VoidCallback _onTap;

  CorrentWrongOverlay(this._isCorrect, this._onTap);

  @override
  State createState() => new CorrentWrongOverlayState();
}

class CorrentWrongOverlayState extends State<CorrentWrongOverlay> with SingleTickerProviderStateMixin {
